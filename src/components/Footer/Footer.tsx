        ...
        <div className={`${inter.className} hidden w-full  md:flex  justify-between px-8 bg-white text-[#565E74] text-xs`}>
            <div className="flex m-1">
                <ul className={`flex flex-row gap-6 font-medium ${inter.className} `}>
                    ...
                    <li className="cursor-pointer" onClick={() => { router.push("/Support")}}>Support</li>
                    <li className="cursor-pointer" onClick={() => { router.push("/Privacy")}}>Privacy</li>
                    <li className="cursor-pointer" onClick={() => { router.push("/Terms")}}>Terms</li>
                </ul>
            </div>
